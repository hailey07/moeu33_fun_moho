...
2. 删除以下路径文件夹 ↓↓↓
     ...
     <div class="gallery-row" style="max-width:500px;display:flex; flex-direction: column;
...
3. 重新安装Moho，启动后出现注册页面即为重装成功
    ...
    <div class="gallery-row" style="max-width:500px;display:flex; flex-direction: column;
        align-items: flex-start;gap:10px;">
       <img src="https://bucket.moeu33.fun/2026/01/1768597847625-Untitled.png"/>
    </div>
...
2. 删除以下路径文件夹 ↓↓↓
    ...
    <div class="gallery-row" style="max-width:600px;display:flex; flex-direction: column;
        align-items: flex-start;gap:10px;">
...
4. <div class="gallery-row" style="max-width:550px;display:flex; flex-direction: column;
        align-items: flex-start;gap:10px;">
       <img src="https://bucket.moeu33.fun/2026/01/1768597960796-Untitled (1).png"/>
    </div>